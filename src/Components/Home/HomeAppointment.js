...
const HomeAppointment = () => {
    return (
        <div className='lg:mt-72 mb-32 bg-appointment-background w-full p-4 lg:py-0 lg:px-44'>
            <div class=" md:grid  md:grid-cols-2  text-left items-center md:text-left">
                ...
                <div class="align-middle text-left ">
                    ...
                    <h2 class=" text-4xl font-bold w-full text-white">Make an appointment Today</h2>
                    <p class="mt-7  text-white">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsumis that it has a more-or-less normal distribution of letters,as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page</p>

...
const Contact = () => {
    return (
        <div className='min-h-screen  my-16 lg:mt-0 bg-appointment-background  py-20 mx-auto grid grid-cols-1 justify-center '>
            ...
            <input type="text" placeholder="Subject" class="input w-full max-w-xs mx-auto" />
            <textarea class="textarea w-full max-w-xs mx-auto pb-16" placeholder="Your Message"></textarea>

...
const Reviews = () => {
    ...
    return (
        <div className='px-4 lg:px-10 lg:min-h-screen mt-32 justify-center'>
            ...
            <div className='lg:mb-20 review-container  flex justify-between'>
                <div className='text-left w-2/4 lg:w-full' >
                    <h3 className='text-xl text-secondary uppercase font-bold mb-2' > Testimonial</h3>
                    <h2 className='lg:text-3xl text-2xl uppercase mb-20'>What Our Patients Says</h2>
                </div>
                <div>
                    <img className='w-24 md:w-48' src={leftQuote} alt=""></img>
                </div>
            </div>
